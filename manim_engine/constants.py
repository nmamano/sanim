...
if os.path.exists("manim_engine/media_dir.txt"):
    with open("manim_engine/media_dir.txt", 'rU') as media_file:
        MEDIA_DIR = media_file.readline().strip()

if not os.path.exists(MEDIA_DIR):
    raise Exception("""
        Redefine MEDIA_DIR = """+MEDIA_DIR+""" by changing the MEDIA_DIR
        environment constant or by changing
        media_dir.txt to point to a valid directory
        where movies and images will be written
    """)

with open("manim_engine/media_dir.txt", 'w') as media_file:
