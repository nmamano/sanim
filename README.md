...
The following sanim source generates [this animation](demo.html). In the animation, use the left arrow to advance and the right arrow to go back. (If the demo does not work, [here](demo.mp4) is the raw video without the advance/go back features.)
